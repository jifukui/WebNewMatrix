...
em_emphasis=5,
em_pc_dvd=6,
em_video_compensation=7,
em_hdcp_out_set=8,
em_hdmi_out_set=9,
em_colorspace_out_set=10,
em_deepcolor_out_set=11,
em_pattern_select=12,
em_out_mode=13,
em_brightness=14,
em_contrast=15,
em_hue=16,
em_color_saturation=17,
em_sharpness=18,
em_color_temperature=19,
em_motion_contrast=20,
em_gamma=21,
em_video_filter_type_set=22,
em_y_delay=23,
em_phase_adjustment=24,
em_gain_adjustment=25,
em_equalization_adjustment=26,
em_emphasis_adjustment=27,
em_compensation_adjustment=28,
em_fan_status=29,
em_card_port_reset=30,
em_scale_cut_mode=31,
em_out_windows_adjust=32,
em_video_freeze=33,
em_tv_format=34,
em_video_format=35,
em_picture_aspect_ratio_mode1=36,
em_picture_aspect_ratio_mode2=37,
em_pbp_adjustment=38,
em_out_resolution=39,
em_input_hor_position_adjustment=40,
em_input_ver_position=41,
em_input_hor_size_adjustment=42,
em_input_ver_size_adjustment=43,
em_output_hor_position_adjustment=44,
em_output_ver_position_adjustment=45,
em_output_hor_size_adjustment=46,
em_output_ver_size_adjustment=47,
em_zoom_b_hor_position_adjustment=48,
em_zoom_b_ver_position_adjustment=49,
em_zoom_b_hor_size_adjustment=50,
em_zoom_b_ver_size_adjustment=51,
em_zoom_w_hor_position=52,
em_zoom_w_ver_position=53,
em_zoom_w_hor_size_adjustment=54,
em_zoom_w_ver_size_adjustment=55,
em_resolution=56,
em_hor_total_pixels_set=57,
em_ver_total_pixels_set=58,
em_get_max_input_pixel_clock=59,
em_horizontal_start=60,
em_horizontal_active=61,
em_vertical_start=62,
em_vertical_active=63,
em_dp_channels=64,
em_dpcp=65,
em_restore_setup=66,
em_recall_setup=67,
em_switch_speed=68,
em_volume=69,
em_background_volume=70,
em_mic_volume=71,
em_audio_balance=72,
em_background_balance=73,
em_mic_balance=74,
em_audio_bass=75,
em_audio_treble=76,
em_audio_sample_frequency=77,
em_audio_sample_size=78,
em_audio_mute=79,
em_audio_midrange=80,
em_audio_loudness=81,
em_audio_mix_mode=82,
em_audio_stereo_mode=83,
em_audio_talk_over=84,
em_audio_aux_delay=85,
em_audio_select=86,
em_audio_channel=87,
em_signal_information=88,
em_inport_information=89,
em_monitor_information=90,
em_outport_information=91,
em_temperature=92,
em_voltage=93,
em_edid_status=94,
em_bus_status=95,
em_gen2_arc_enable_disable=96,
em_gen2_ana_3_5_dir,
